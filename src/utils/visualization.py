...
def plotObjective(objective, answers, cmap=plt.cm.coolwarm, clabel='Likelihood', d=0, r=100, area=None, ax=None):
    fig, ax, area = figure(ax, area)
...
def savefig(fig, title, destinations): 
    for path in destinations:
        ...
        fig.savefig(f"{path}/{title}.eps", bbox_inches='tight') 